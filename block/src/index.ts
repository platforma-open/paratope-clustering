...
import { platforma } from "@platforma-open/milaboratories.paratope-clustering.model";
import {
  InferOutputsType,
  InferDataType,
  InferHrefType,
...
export type ParatopeClusteringBlockContract = BlockContract;
export type ParatopeClusteringBlockOutputs  = BlockOutputs;
export type ParatopeClusteringBlockData     = BlockData;
export const ParatopeClusteringBlockPointer = BlockPointer;
